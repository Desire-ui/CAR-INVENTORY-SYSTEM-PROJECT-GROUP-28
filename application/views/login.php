...
<head>
  <meta charset="utf-8">
	...
	<title>
	   <?php echo $this->config->item('company'); ?> | POS |  Login
	</title>
...
<body class="bg-light d-flex flex-column" style="
    background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), 
                url('<?php echo base_url('uploads/' . $this->Appconfig->get('company_logo')); ?>');
    ...
    <div class="container-login container-fluid d-flex flex-column flex-md-row bg-body shadow rounded m-3 p-4 p-md-0" >
      ...
      <section class="box-login d-flex flex-column justify-content-center align-items-center p-md-4">
				...
				<h3 class="text-center m-0">
				    Welcome to <?php echo $this->config->item('company'); ?>|  Inventory
				</h3>
      ...
      <?php elseif ('input_groups'==($this->config->item('login_form'))): ?>
        ...
        ?>
        <div class="d-grid">
          <button class="btn btn-lg btn-primary" style="background: #1565C0 !important" name="login-button" type="submit" >
