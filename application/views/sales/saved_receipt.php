    ...
    <div class="container">
        <div class="row" style="padding-top: 10px;">
            ...
            <div class="col-md-3 text-left">
                <?php if($this->config->item('company_logo') != '') { ?>
                    <img src="<?php echo base_url('uploads/' . $this->config->item('company_logo')); ?>" alt="company_logo" class="img-fluid" style="max-height: 50px;">
                <?php } ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <strong>Quotation Date:</strong> <?php echo $transaction_time; ?>
            </div>
        </div>

        <p>Dear Sir/Mam,</p>
        <p>Thank you for your valuable inquiry. We are pleased to quote as below:</p>
        ...
        <div class="row">
            <div class="col-md-6 text-right">
                <p><strong><?php echo $this->lang->line('sales_total'); ?>:</strong></p>
            </div>
            <div class="col-md-6 text-right">
                <p><strong><?php echo to_currency($total); ?></strong></p>
                
                 <p><strong>SUBTOTAL:</strong> <?php echo to_currency($total); ?></p>
    <p><strong>TAX (18.00%):</strong> <?php echo to_currency($total * 0.18); ?></p>
    <p><strong>GRAND TOTAL:</strong> <?php echo to_currency($total + ($total * 0.18)); ?></p>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <p><a style="text-decoration:none; color: black" class="text-dark" href="#" data-toggle="modal" data-target="#soldByModal">Sold By:</a> <span id="selectedSalesperson"></span></p>
            </div>
        </div>
